...
-- Listage des données de la table elansessions.programme : ~5 rows (environ)
...
-- Listage de la structure de table elansessions. reset_password_request
...
-- Listage des données de la table elansessions.reset_password_request : ~0 rows (environ)
...
-- Listage des données de la table elansessions.session : ~5 rows (environ)
REPLACE INTO `session` (`id`, `formation_id`, `formateur_id`, `titre`, `date_session_debut`, `date_session_fin`, `places`, `coordonnees`) VALUES
	(1, 1, 3, 'Session de printemps', '2023-03-21', '2023-06-21', 20, NULL),
	(2, 2, 2, 'Session d\'été', '2023-06-22', '2023-09-25', 30, NULL),
	(3, 2, 1, 'Session d\'automne', '2023-09-23', '2023-12-21', 30, NULL),
	(4, 1, 1, 'Session d\'hiver', '2023-11-01', '2024-02-21', 30, NULL),
	(8, 2, 2, 'Session géolocalisée', '2023-02-15', '2023-05-06', 50, '48.56054003154205 7.737550735473634');
...
-- Listage des données de la table elansessions.stagiaire : ~13 rows (environ)
REPLACE INTO `stagiaire` (`id`, `nom`, `prenom`, `date_de_naissance`, `email`) VALUES
	...
	(14, 'Nouvo', 'Stajier', '1980-10-03', 'mortasd@gy.fr'),
	(17, 'PEAXzqad', 'aeazdqDDDD', '2000-05-05', 'AAAs@pe.de');
...
-- Listage des données de la table elansessions.stagiaire_session : ~14 rows (environ)
...
-- Listage des données de la table elansessions.user : ~1 rows (environ)
